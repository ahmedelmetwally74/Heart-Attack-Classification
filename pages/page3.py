...
layout = dbc.Container(children=[
    dbc.Row([
        html.Div([
            html.H2(
                "Heart Attack Risk based on Max heart rate and Age",
                className='mb-4',
                style={
                    'color': '#144a51',
                    'font-weight': 'bold',
        ...
        html.H6(
            [search_icon, "Explore how Max heart rate achieved vary with age and their relationship to heart attack risk."],
            style={
                'text-align': 'left',
                'margin-top': '10px',
                'font-size': 20,
        ...
        dbc.Row([
            dbc.Col([
                ...
                dcc.Graph(id='thalach_vs_age_graph', style={"width": "100%", "height": "70vh"})
...
@app.callback(
    Output('thalach_vs_age_graph', 'figure'),
...
def update_graph(selected_risk):
    ...
    fig = px.scatter(
        ...
        title="Max heart rate achieved during exercise by Age and Risk",
        labels={"thalach": "Max heart rate achieved", "age": "Age"}
    )
